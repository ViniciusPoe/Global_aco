...
<div class="container-fluid px-0">
    <div class="position-relative">
        <img src="<?= ASSETS_URL ?>/images/sobre.jpg" 
             alt="Sobre" 
             class="img-fluid w-100" 
             style="height: 60vh; min-height: 400px; object-fit: cover; object-position: center;">
    </div>
</div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <p>Em 2023, demos nosso primeiro passo com uma linha essencial de tubos galvanizados. Hoje, orgulhosamente oferecemos:</p>
            ...
            <div class="col-lg-6">
                <div class="about-image-box p-1 bg-white shadow">
                    <img src="<?= ASSETS_URL ?>/images/team-working.jpg" alt="global Aços" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </div>
