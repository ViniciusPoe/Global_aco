...
<!-- Hero Section -->
<section class="contact-hero bg-navy text-white py-5">
    <div class="container py-4">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                <h1 class="fw-bold mb-3 text-white">Fale com a Global Aços</h1>
                <p class="lead mb-0">Solicite um orçamento, tire dúvidas ou agende uma visita técnica</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body p-4">
                        ...
                        <form action="<?= BASE_URL ?>/processa_contato.php" method="post" id="form-contato">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-navy btn-lg w-100 py-3">
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="social-links d-flex justify-content-center gap-3">
                            ...
                            <a href="#" class="btn btn-outline-navy rounded-circle"><i class="fab fa-linkedin-in"></i></a>
